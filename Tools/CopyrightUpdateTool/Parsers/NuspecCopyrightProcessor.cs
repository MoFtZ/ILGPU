...
//                                    www.ilgpu.net
//
// File: NuspecCopyrightProcessor.cs
//
...
namespace CopyrightUpdateTool.Parsers
{
    ...
    /// </summary>
    class NuspecCopyrightProcessor : BaseCopyrightParser
    {
        #region Instance
        ...
        public NuspecCopyrightProcessor(IVersionControlService versionControlService)
        ...
        public override Task<bool> CanParseAsync(
            ...
            Task.FromResult(file.Name.EndsWith(".nuspec.targets"));
